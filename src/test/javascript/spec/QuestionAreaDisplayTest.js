...
describe("QuestionAreaDisplay", function () {
    it("buildQuestionAreaElement", function () {
        let questionTextArea="Is this a question?";
        let questionTextNode= buildQuestionAreaElementUnchangable(questionTextArea);
        let element = buildQuestionAreaElement("ao", questionTextNode, document.createElement("text"));
