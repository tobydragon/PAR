...
public class LevelMessageGeneratorAttachmentTest {
    @Test
    public void generateMessageTest() throws IOException { //TODO: will start failing once calcLevelFix stuff is in here
        //task generator

        LevelMessageGeneratorAttachment lmg = new LevelMessageGeneratorAttachment();

        TaskGenerator taskGenerator = new LevelTaskGenerator(EquineQuestionTypes.makeLevelToTypesMap());

        QuestionPool myQP = new QuestionPool(new JsonQuestionPoolDatastore("src/test/resources/author/questionPools/TestQP.json").getAllQuestions());
    ...
    public void increaseLevelTest() throws IOException{
        ...
        level2Student.setCurrentLevel(2);
        level2Student.setPreviousLevel(1);
        message = LevelMessageGeneratorAttachment.increaseLevelMessage(level2Student);
        assertEquals("You're doing great!", message);
    ...
    public void level6MessageTest() throws IOException{
        ...
        //stay on level 6, repeated question
        masteredStudentModel.setPreviousLevel(6);
        masteredStudentModel.setCurrentLevel(6);
    ...
    public void repeatLevelMessageTest() throws IOException{
        ...
        String message = LevelMessageGeneratorAttachment.repeatLevelMessage(student30, it30);
        ...
        message = LevelMessageGeneratorAttachment.repeatLevelMessage(student29, it29);
        assertEquals("You've seen this question recently, you might be stuck on plane/structure questions.", message);
        ...
        message = LevelMessageGeneratorAttachment.repeatLevelMessage(student31, it31);
        assertNull(message);
        ...
        message = LevelMessageGeneratorAttachment.repeatLevelMessage(student, it);
        assertNull(message);
    ...
    public void decreaseLevelTest() throws IOException, InterruptedException{
        ...
        assertEquals("Looks like you're having trouble with zone questions, go look at resources and come back if you need to", LevelMessageGeneratorAttachment.decreaseLevelMessage(masteredStudentModel));
        ...
        assertEquals("Looks like you're having trouble with attachment questions, go look at resources and come back if you need to", LevelMessageGeneratorAttachment.decreaseLevelMessage(masteredStudentModel));
        ...
        assertEquals("Looks like you're having trouble with structure questions, go look at resources and come back if you need to", LevelMessageGeneratorAttachment.decreaseLevelMessage(masteredStudentModel));
        ...
        assertEquals("Looks like you're having trouble with plane/structure questions, go look at resources and come back if you need to", LevelMessageGeneratorAttachment.decreaseLevelMessage(masteredStudentModel));
