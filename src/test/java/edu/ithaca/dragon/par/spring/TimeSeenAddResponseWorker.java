...
public class TimeSeenAddResponseWorker implements Runnable{
    private String questionId;
    private String studentId;
    private MockMvc mockMvc;
    private int numRunIter;
    public TimeSeenAddResponseWorker(String questionId, String studentId, MockMvc mockMvc, int numRunIter){
