...
public class StressTestUsersForAddTimeSeenAddResponseWorker implements Runnable{
    private MockMvc mockMvc;
    private int numRunIter;
    private String cohortId;
    private int threadNum;
    public StressTestUsersForAddTimeSeenAddResponseWorker(String cohortId, MockMvc mockMvc, int threadNum, int numRunIter){
