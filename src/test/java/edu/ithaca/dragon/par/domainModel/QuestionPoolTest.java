...
public class QuestionPoolTest {
    ...
    public void getQuestionFromId() throws IOException {
        ...
        QuestionPool qp2 = new QuestionPool(new JsonStudentModelDatastore("src/test/resources/author/DemoQuestionPoolFollowup.json").loadQuestions());
    ...
    public void getQuestionsFromIdsTest() throws IOException {
        ...
        try{
            QuestionPool qp2 = new QuestionPool(new JsonStudentModelDatastore("src/test/resources/author/SampleQuestionPool.json").loadQuestions());
        ...
        QuestionPool qp3 = new QuestionPool(new JsonStudentModelDatastore("src/test/resources/author/SampleQuestionPool.json").loadQuestions());
        ...
        //no Ids in list
        try{
            QuestionPool qp4 = new QuestionPool(new JsonStudentModelDatastore("src/test/resources/author/SampleQuestionsEmpty.json").loadQuestions());
    ...
    public void checkWindowSizeTest() throws IOException{
        QuestionPool qp = new QuestionPool(new JsonStudentModelDatastore("src/test/resources/author/SampleQuestionPool3.json").loadQuestions());
        ...
        QuestionPool qp2 = new QuestionPool(new JsonStudentModelDatastore("src/test/resources/author/DemoQuestionPool2.json").loadQuestions());
    ...
    public void removeQuestionFromIdTest() throws IOException{
        QuestionPool qp = new QuestionPool(new JsonStudentModelDatastore("src/test/resources/author/DemoQuestionPoolFollowup.json").loadQuestions());
